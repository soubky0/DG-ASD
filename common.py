...
def get_argparse():
    ...
    parser.add_argument(
        "--use_cuda", type=str2bool, default=True, help="enables CUDA training"
    )
    parser.add_argument(
        "--gpu_id",
        type=int,
    ...
    # feature
    parser.add_argument(
        "--n_mels", type=int, default=128, help="Length of the melfilter bank"
    )
    parser.add_argument(
        "--frames", type=int, default=5, help="Number of frames in a feature vector"
    )
    parser.add_argument(
        "--frame_hop_length",
        type=int,
    ...
    parser.add_argument(
        "--shuffle", type=str, default="full", help="shuffle type (full , simple)"
    )
    ...
    # resume learning
    parser.add_argument(
        "--restart", action="store_true", help="Resume learning with checkpoint"
    )
    parser.add_argument(
        "--checkpoint_path",
        type=str,
    ...
    parser.add_argument(
        "--train_only", action="store_true", default=False, help="Run train only"
    )
    parser.add_argument(
