...
class TimeFrequencyFigData:
    def __init__(
        self, max_imgs=1, max_extract=1, frames=5, frame_hop_length=1, shape=(1, 128, 5)
    ):
    ...
    def append_figdata(
        self, data, label, machine_id, idx, fig_name="", is_fig_tern=False
    ):
        ...
        imgs = data[
            : self.frames
            * self.max_extract
            // self.frame_hop_length : self.frames
            // self.frame_hop_length
        ].cpu()
